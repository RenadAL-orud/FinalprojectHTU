  ...
  <header class="header">
    ...
    <div class="header_content d-flex flex-row align-items-center justify-content-start">
      ...
      <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
        ...
        <!-- User -->
        <div class="user"><a href="#"><div><img src="images/cart.svg" alt="https://www.flaticon.com/authors/freepik"><div><?php 
         if (isset($_SESSION['cart2'])) {
           # code...
          ...
          <div class="col">
            ...
            if (isset($_SESSION['cart2'])) {
               $conn=mysqli_connect("localhost","root","","electronictrade");
                        ...
                        $count = 0;
                        $total=0;
                   foreach ($_SESSION['cart2'] as $x=> $code) {
                  ...
                  $a=$product['idprodect'];
                   ...
                   <?php echo '<div>'.$_SESSION['size1'][$count] . '</span></div>';
                   $count++;
                   ?>
                   <?php
                     echo "<div class='product_price product_text'><span></span>{$product['priceprodect']}.00JOD</div>
                     <div class='product_price product_text'><span></span><a href='a.php?id1=$x'><i class='fa fa-close'style='color:red'></i></a></div>
...
";
              ...
              <div class="button button_clear trans_200"><a href="a.php?idcart">clear cart</a></div>
           ...
           <div class="col-lg-6 cart_extra_col">
            ...
            <div class="cart_extra_title">Cart Total</div>
             <ul class="cart_extra_total_list">
                ...
                <div class="checkout_button trans_200"><a href="logincustomer.php"class="btn btn-info btn-lg">proceed to checkout</a></div>
              </div>
            </div>
          </div>
